...
/*      Huvudprogram för IBM-proprinter matrisskrivare.
 *
...
/*
***Defaultvärde för upplösning. IBM-proprinter kan plotta
...
***24-pinnars mode är den 29/24 av 216/tum.
***
...
***samt plotterns dito. Vektorklipp behövs ej.
*/
   pllpfp("ibmpro.PEN");
   arccon = FALSE;
