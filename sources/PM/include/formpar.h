...
*/
     "-5:se",
/*
***VINPMT  = 193, INPMT.   OBS OBS ie borde v� vara id ????
***�en se kan vara default.
*/
     "s5:se.se.1(ie<0>)",
/*
...
*/
     "-5:vv.vv",
/*
***VCRWIN = 231, win_id:=CRE_WIN(pos,dx,dy,label�typ�;
*/
...
*/
     "i5:ie.ie",
/*
***VDLWIN = 240, DEL_WIN(win_id�subwin_id�;
*/
     "-5:ie.1(ie)",
/*
...
*/
     "-5:re.ie.se.1(id<0>)",
/*
***VSURCON = 245, SUR_CONIC. F� antal strippar se MXLSTP i V3.h.
*/
